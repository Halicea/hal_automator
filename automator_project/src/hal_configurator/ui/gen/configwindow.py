...
class Ui_ConfigWindow(object):
    def setupUi(self, ConfigWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/buttons/images/select_bundles.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionEnable_Disable_Bundles.setIcon(icon1)
        ...
        self.actionDebug.setIcon(icon2)
